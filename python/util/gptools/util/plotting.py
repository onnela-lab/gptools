...
def plot_band(
    ...
    **kwargs
    ...
    Args:
        x: Coordinates of samples with shape :code:`(n,)`, where :code:`n` is the number
            of observations.
        ys: Samples with shape :code:`(m, n)`, where :code:`m` is the number of samples.
        p: Tail probability to exclude from the credible band such that the band spans
            the quantiles :code:`[p / 2, 1 - p / 2]`.
