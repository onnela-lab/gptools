...
def test_evaluate_log_prob_rfft2(
    ...
    cov_rfft2 = np.fft.rfft2(cov2)
    log_prob_rfft = fft.evaluate_log_prob_rfft2(y2, loc2, cov_rfft2=cov_rfft2)
    np.testing.assert_allclose(log_prob, log_prob_rfft)


def test_pack_rfft2_roundtrip(batch_shape: Tuple[int], rfft2_shape: int) -> None:
