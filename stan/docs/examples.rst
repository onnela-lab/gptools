...
- :doc:`getting_started/getting_started` expands on the :ref:`getting-started` section on the homepage and illustrates the use of `cmdstanpy <https://github.com/stan-dev/cmdstanpy>`_ to draw samples. The example considers centered and non-centered :ref:`parameterizations` for :ref:`Fourier-methods`.
